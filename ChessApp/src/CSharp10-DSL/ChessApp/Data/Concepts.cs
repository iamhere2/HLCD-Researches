...
{
    [Value("CA")]
    public abstract record class Turn
    {
    }
    ...
    public sealed class BoardState
    {
        private static readonly ReadOnlyDictionary<Cell, (Figure, Color)> None =
            new(new Dictionary<Cell, (Figure, Color)>());
    ...
    // Just a syntaxic grouper for some constants and functions
    ...
    [Value("CA")]
    public record class Move(Cell From, Cell To) : Turn;

    [Value("CA")]
    public record struct RuleViolation(string Description);
}
