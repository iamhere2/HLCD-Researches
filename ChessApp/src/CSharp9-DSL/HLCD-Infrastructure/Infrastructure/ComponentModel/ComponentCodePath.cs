...
namespace HLCD.Infrastructure.ComponentModel
{
    public record ComponentCodePath
    {
        ...
        private static readonly Regex CodePathRegex = new Regex(CodePathRegexPattern, RegexOptions.Compiled);
        ...
        public static readonly ComponentCodePath Empty = new ComponentCodePath(string.Empty);
    }
}
